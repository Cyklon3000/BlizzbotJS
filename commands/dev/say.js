...
async function run(client, interaction) {
    ...
    if (!channel) channel = await client.channels.fetch(config.discord.channels.standard);
    if (!(channel instanceof TextChannel)) return await interaction.reply("Der in der Config angegebene Kanal ist kein Textkanal.");
